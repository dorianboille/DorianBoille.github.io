...
document.addEventListener('DOMContentLoaded', () => {
    ...
    displayProjects(projects.professional, 'professional-projects-grid');

    // Gestionnaire de recherche pour les projets professionnels
    document.getElementById('professional-search').addEventListener('input', (e) => {
        const filtered = filterProjects(projects.professional, e.target.value);
        displayProjects(filtered, 'professional-projects-grid');
    });
});